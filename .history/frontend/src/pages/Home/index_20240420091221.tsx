import { Container, Header, Info, Logo, LogoDiv, SearchBarDiv, SelectOnBar, TagDiv } from "./styles"
  ...
  return (
    <Container >
      <Header>
        ...
        <SearchBarDiv>
          <SelectOnBar value={selectedOption} onChange={handleOptionChange}>
          ...
          <input
            ...
            placeholder="Pesquise variádas imagens e videos de alta qualidade"
          />
        </SearchBarDiv>
